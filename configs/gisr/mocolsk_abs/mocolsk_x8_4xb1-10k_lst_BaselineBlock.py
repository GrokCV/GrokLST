...
scale = 8
# model settings
# module=['BaselineBlock','MoCoLSKBlock','LSKMBlock','SKMBlock', 
# "InvMoCoLSKBlock", "MoCoLSKWithoutPPMBlock", 
# "InvMoCoLSK_MBlock", "MoCoLSK_MBlock", "LSKCSMBlock", "MoCoLSKCSBlock",
# "MoCoLSKWithSmallKernelBlock_k3d1p1_k3d2p2", 
# "MoCoLSKWithSmallKernelBlock_k3d1p1_k5d1p2",
# "MoCoOneLKBlock", "MoCoLSKWithSmallKernelBlock_k3d1p1_k5d2p4",
# "MoCoLSKPathwayBlock", "MoCoLSKPathwayBlock_Guidance",
# "MoCoLSKWithSmallKernelBlock_k7d1p3_k9d4p16"]
module = "BaselineBlock"
model = dict(
    type="BaseEditModel",
    generator=dict(
        type="MoCoLSKNetABS",
