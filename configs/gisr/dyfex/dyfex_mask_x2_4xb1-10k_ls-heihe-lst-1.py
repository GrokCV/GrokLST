...
# sigmoid or threshod
__all__ = [ # ---------------------------   1    ----------------------------------
            'DynamicChannelExchangeWithCatBlock', 'DynamicChannelExchangeWithoutCatBlock', "DynamicChannelExchangeWithConvCatBlock"]
...
#             "DynamicChannelExchangeWithECACatBlock", 
# #=====================================================
#               "ChannelAttExchangeBlock"]
module = 'ChannelAttExchangeBlock'
model = dict(
    type="BaseEditModel",
    generator=dict(
        type="DyFeXNetMask",
