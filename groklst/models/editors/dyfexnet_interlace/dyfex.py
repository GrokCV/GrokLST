...
__all__ = [ 'ResidualGroup', 'CALayer', 
            ...
            # -------------------------------------------------------------
            # interlace
            "ChannelOrSpatialExchangeWithCatBlock","ChannelOrSpatialExchangeWithConvCatBlock",]
...
class ChannelOrSpatialExchangeWithCatBlock(nn.Module):
    def __init__(self, lst_dim, gui_dim, scale, channel_flag=True):
        super().__init__()
...
class ChannelOrSpatialExchangeWithConvCatBlock(nn.Module):
    def __init__(self, lst_dim, gui_dim, scale, channel_flag=True):
        super().__init__()
        self.lst_up = DenseProjection(lst_dim, gui_dim, scale, up=True, bottleneck=False)
        if channel_flag:
