...
class PMBANet2(BaseModule):
    ...
    def __init__(self, 
        ...
        # Multi-view prior
        self.m1 = MultiViewBlock1(64, 6, 2, 2)
        self.m2 = MultiViewBlock2(2 * 64, 6, 2, 2)
        self.m3 = MultiViewBlock3(3 * 64, 6, 2, 2)
        self.m4 = MultiViewBlock4(4 * 64, 6, 2, 2)
...
if __name__ == "__main__":
    ...
    x = torch.randn((2, 1, 112, 112)).cuda()
    hr_guidance = torch.randn((2, 10, 224, 224)).cuda()
    net = PMBANet2().cuda()
