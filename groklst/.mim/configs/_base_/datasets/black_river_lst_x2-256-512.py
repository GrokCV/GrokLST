...
## 60m 每种guidance数据的归一化参数：
gui_norm_paras = dict(
    dem=dict(mean=2569.36, std=1254.34, min=905.53, max=5079.09),
    deepblue=dict(mean=0.17, std=0.05, min=0.00, max=0.71),
    blue=dict(mean=0.16, std=0.04, min=0.00, max=0.47),
    ...
    ndmvi=dict(mean=0.19, std=0.13, min=-0.93, max=0.96),
    ndvi=dict(mean=0.14, std=0.09, min=-0.47, max=0.70),
    ndwi=dict(mean=-0.19, std=0.12, min=-0.56, max=0.75)
)
# LST 60m 数据的归一化参数：
