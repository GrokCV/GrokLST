...
## 240m 每种guidance数据的归一化参数：
gui_norm_paras = dict(
    dem=dict(mean=2569.36, std=1254.21, min=906.20, max=5033.14),
    deepblue=dict(mean=0.17, std=0.05, min=0.00, max=0.69),
    blue=dict(mean=0.16, std=0.04, min=0.00, max=0.45),
    green=dict(mean=0.15, std=0.03, min=0.00, max=0.36),
    red=dict(mean=0.17, std=0.04, min=0.00, max=0.39),
    vre=dict(mean=0.20, std=0.05, min=0.00, max=0.61),
    nir=dict(mean=0.22, std=0.05, min=0.00, max=0.54),
    ndmvi=dict(mean=0.19, std=0.12, min=-0.83, max=0.87),
    ndvi=dict(mean=0.14, std=0.09, min=-0.40, max=0.69),
    ndwi=dict(mean=-0.19, std=0.11, min=-0.54, max=0.62),
)
